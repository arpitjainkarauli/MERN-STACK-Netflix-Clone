...
import MovioLogo from "../assets/homeTitle.webp";
...
function Netflix() {
  ...
  useEffect(()=> {
    if(genresLoaded) dispatch(fatchMovies({type: "all" }));
  }, [genresLoaded])  
...
// console.log(movies);
return (
<Container><Nav isScrolled = {isScrolled} />
...
<div className='hero'>
  ...
  <div className='container'>
    ...
    <div className="logo">
      <img src={MovioLogo} alt="movie logo" />
    </div>
